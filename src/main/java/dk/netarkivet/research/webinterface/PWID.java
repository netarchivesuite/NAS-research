...
public class PWID {
	...
	public static void main(String[] args) throws ParseException, PwidParseException {
		...
		System.out.println(pwid);
		String pwid2 = "pwid::2016-01-22_11.20.29Z:page:http://www.dr.dk";
	...
	public String toString() {
		return "pwid:" + archiveId + ":" + getDateFormat().format(timestamp) + ":" + coverage + ":" + uri; 
	}
	
	public static DateFormat getDateFormat() {
		DateFormat warcDateFormat = new SimpleDateFormat(WARC_DATE_FORMAT);
	...
	public static PWID parsePWID(String input) throws PwidParseException {
		...
		Date timestamp = null;
		try {
			timestamp = getDateFormat().parse(dateString);
